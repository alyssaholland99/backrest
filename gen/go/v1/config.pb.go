...
type Plan struct {
	...
	Notifications   *Notifications         `protobuf:"bytes,14,opt,name=notifications,proto3" json:"notifications,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Plan) GetNotifications() *Notifications {
	if x != nil {
...
type Notifications struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NotifySuccess bool                   `protobuf:"varint,1,opt,name=notify_success,json=notifySuccess,proto3" json:"notify_success,omitempty"`
	NotifyFail    bool                   `protobuf:"varint,2,opt,name=notify_fail,json=notifyFail,proto3" json:"notify_fail,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Notifications) GetNotifySuccess() bool {
	if x != nil {
...
func (x *Notifications) GetNotifyFail() bool {
	if x != nil {
		return x.NotifyFail
	}
	return false
...
const file_v1_config_proto_rawDesc = "" +
	...
	" \x01(\v2\x11.v1.CommandPrefixR\rcommandPrefix\"\x92\x03\n" +
	"\x04Plan\x12\x0e\n" +
	...
	"\x11skip_if_unchanged\x18\r \x01(\bR\x0fskipIfUnchanged\x127\n" +
	"\rnotifications\x18\x0e \x01(\v2\x11.v1.NotificationsR\rnotificationsJ\x04\b\x03\x10\x04J\x04\b\x06\x10\aJ\x04\b\v\x10\f\"W\n" +
	"\rNotifications\x12%\n" +
	"\x0enotify_success\x18\x01 \x01(\bR\rnotifySuccess\x12\x1f\n" +
	"\vnotify_fail\x18\x02 \x01(\bR\n" +
	"notifyFail\"\x9b\x02\n" +
	"\rCommandPrefix\x126\n" +
...
var file_v1_config_proto_goTypes = []any{
	...
	(*Repo)(nil),                               // 10: v1.Repo
	(*Plan)(nil),                               // 11: v1.Plan
	(*Notifications)(nil),                      // 12: v1.Notifications
...
var file_v1_config_proto_depIdxs = []int32{
	...
	22, // 6: v1.Multihost.known_hosts:type_name -> v1.Multihost.Peer
	22, // 7: v1.Multihost.authorized_clients:type_name -> v1.Multihost.Peer
	...
	13, // 11: v1.Repo.command_prefix:type_name -> v1.CommandPrefix
	17, // 12: v1.Plan.schedule:type_name -> v1.Schedule
	14, // 13: v1.Plan.retention:type_name -> v1.RetentionPolicy
	18, // 14: v1.Plan.hooks:type_name -> v1.Hook
	12, // 15: v1.Plan.notifications:type_name -> v1.Notifications
	...
	17, // 19: v1.PrunePolicy.schedule:type_name -> v1.Schedule
	17, // 20: v1.CheckPolicy.schedule:type_name -> v1.Schedule
	...
	20, // 31: v1.Auth.users:type_name -> v1.User
